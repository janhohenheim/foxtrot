...
/// - [`actions::plugin`]: Handles player input such as mouse and keyboard and neatly packs it into an [`actions::Actions`] resource.
/// - [`camera::plugin`]: Handles camera movement.
/// - [`player_embodiment::plugin`]: Tells the components from [`super::movement::plugin`] about the desired player [`actions::Actions`].
